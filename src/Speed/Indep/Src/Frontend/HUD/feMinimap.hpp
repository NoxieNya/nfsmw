...
class Minimap : public HudElement {
  ...
  private:
    ...
    static const uint32 mMapPieces = 4; // size: 0x4, address: 0xFFFFFFFF, Decl: speed/indep/src/frontend/hud/FeMinimap.hpp:94

    FEObject *TrackmapLayout;                // offset 0x30, size 0x4, Decl: speed/indep/src/frontend/hud/FeMinimap.hpp:96
    FEMultiImage *TrackmapArt[mMapPieces];   // offset 0x34, size 0x10, Decl: speed/indep/src/frontend/hud/FeMinimap.hpp:97
    FEVector2 TrackmapArtUVs[mMapPieces][2]; // offset 0x44, size 0x40, Decl: speed/indep/src/frontend/hud/FeMinimap.hpp:98
